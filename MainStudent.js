...
const categories = [{ id: 1, title: 'View Assignments' }];

const MainStudent = ({ navigation, route }) => {
  ...
  const renderCategoryCard = (category) => {
    ...
    const handleCategoryPress = (categoryId) => {
      ...
      if (categoryId === 1) {
        navigation.navigate('View', { uid: uid });
      }
    };
    ...
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.headerText}>Student's Desk</Text>
        </View>
